...
function  theta_c = altitude_hold(h_c, h, flag, P)
    ...
    kph = P.kp_h;
    kih = P.ki_h;
    theta_c = sat(kph*error+kih*integratorh, P.theta_max, -P.theta_max);
end
...
function theta_c = airspeed_with_pitch_hold(Va_c, Va, flag, P)
    ...
    kpv2 = P.kp_V2;
    kiv2 = P.ki_V2;
    theta_c = sat(kpv2*error+kiv2*integratorV2, P.theta_max, -P.theta_max);
end
...
function delta_t = airspeed_with_throttle_hold(Va_c, Va, flag, P)
    ...
    kpv2 = P.kp_V2;
    kiv2 = P.ki_V2;
    delta_t = sat(kpv2*error+kiv2*integrator, P.delta_t_max, -P.delta_t_max);
end
